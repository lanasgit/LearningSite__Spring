	    ...
	    <div class="row justify-content-center">
	        <div class="col-lg-6">
	            <div class="section_title text-center mb-70">
	                <span class="wow fadeInUp">Comment Delete</span>
	                <h3 class="wow fadeInUp">댓글 삭제</h3>
	...
	<div class="container">	   
	    <div class="row justify-content-center">
	        <div class="col-lg-6">
	            <div class="section_title text-center mb-70">
	                <span class="wow fadeInUp">Comment Delete</span>
	                <h3 class="wow fadeInUp">댓글 관리자용 삭제</h3>
	                <p class="wow fadeInUp">버튼을 누르시면 아래 댓글이 삭제됩니다</p>
	            </div>
	        </div>
	    </div>
    </div>
